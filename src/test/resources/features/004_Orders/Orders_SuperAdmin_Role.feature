@crud
Feature: Order Tests with SuperAdmin Role
  ...
  Scenario: ONMYC-835 New Order should be creatable
    ...
    And The user selects a Company from company dropdown "Automation_Test" for create order
    ...
    And The user select a Line Manager as a "linemanager_test@yopmail.com | LineManager Test"
